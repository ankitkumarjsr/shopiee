...
class Paymentwj1 extends StatelessWidget {
  Paymentwj1({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg108),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Sukhi Women Jewellery",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Text("Save: \u{20B9} 300.00 (5%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(right: 55),
                                  child: Text("Sold By Sukhi",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
