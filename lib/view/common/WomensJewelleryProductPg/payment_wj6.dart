...
class Paymentwj6 extends StatelessWidget {
  Paymentwj6({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg113),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Shadhi EARRING",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Shadhi Retail",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
