...
class WomensJewelleryProduct4 extends StatelessWidget {
  WomensJewelleryProduct4({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Row(
              children:[
                Text("   Visit The  Blessaro Store",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.blue),),
            ...
            Padding(
              ...
              child: Text("Blessaro  Fancy Evil Eye Necklase Pendant For Women "),
            ),
            ...
            Image(image: AssetImage(imgbg111),height: 320,width:420,),
            ...
            Row(
              children: [
                ...
                Text("Blessaro ",style: TextStyle(color:Colors.blue ,fontWeight: FontWeight.w500),),
            ...
            Container(
              ...
              child: Row(
                children:[
                  // SizedBox(width: 30,),
                  Image(image: AssetImage(imgbg111),height:100,),
                  Text("+",style: TextStyle(fontSize: 30,color:Colors.grey),),
                  Image(image: AssetImage(imgbg109),height: 100,),
                  Text("+",style: TextStyle(fontSize: 30,color:Colors.grey),),
                  Image(image: AssetImage(imgbg110),height: 100,),
                ],
              ),
            ),
            Container(
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg111)),
            ),
            SizedBox(height: 18,),
