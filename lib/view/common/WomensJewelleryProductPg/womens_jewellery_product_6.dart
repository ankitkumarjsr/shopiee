...
import 'package:shopiee/view/common/WomensJewelleryProductPg/payment_wj1.dart';
import 'package:shopiee/view/common/WomensJewelleryProductPg/payment_wj2.dart';
import 'package:shopiee/view/common/WomensJewelleryProductPg/payment_wj3.dart';
import 'package:shopiee/view/common/WomensJewelleryProductPg/payment_wj4.dart';
import 'package:shopiee/view/common/WomensJewelleryProductPg/payment_wj5.dart';
import 'package:shopiee/view/common/WomensJewelleryProductPg/payment_wj6.dart';
...
import '../../screen/HomeScreen/components/Grids/Second/componets/womens-jewellery.dart';

class WomensJewelleryProduct6 extends StatelessWidget {
  WomensJewelleryProduct6({Key? key}) : super(key: key);
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
            onPressed: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) =>WomensJewellery(),
                )),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Row(
              children:[
                Text("   Visit The  Shadhi Store",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.blue),),
            ...
            Padding(
              ...
              child: Text("YouBella Jewellerey Set For Women,Earing,Bracelet & Maang Tika For Women(Mehandi/Haldi) "),
            ),
            ...
            Image(image: AssetImage(imgbg113),height: 320,width:420,),
            ...
            Row(
              children: [
                ...
                Text("Shadhi ",style: TextStyle(color:Colors.blue ,fontWeight: FontWeight.w500),),
            ...
            Container(
              ...
              child: Row(
                children:[
                  // SizedBox(width: 30,),
                  Image(image: AssetImage(imgbg113),height:89,),
                  Text("+",style: TextStyle(fontSize: 30,color:Colors.grey),),
                  Image(image: AssetImage(imgbg109),height: 89,),
                  Text("+",style: TextStyle(fontSize: 30,color:Colors.grey),),
                  Image(image: AssetImage(imgbg110),height: 89,),
                ],
              ),
            ),
            Container(
              ...
              child: Row(
                children: [
                  SizedBox(width: 50,),
                  Text("Buy All Three For \u{20B9}649.00",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                  SizedBox(width: 40,),
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg113)),
            ),
            SizedBox(height: 18,),
