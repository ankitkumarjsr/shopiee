...
class WomensJewelleryProduct1 extends StatelessWidget {
  WomensJewelleryProduct1({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Row(
              children:[
                Text("   Visit The Sukkhi Store",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.blue),),
            ...
            Padding(
              ...
              child: Text("Sukkhi Trendy Kundan Gold Plated Wedding Jewellery Pearl Choker Necklase Set For Women"),
            ),
            ...
            Image(image: AssetImage(imgbg108),height: 320,width:420,),
            ...
            Row(
              children: [
                ...
                Text("Sukkhi Pvt ",style: TextStyle(color:Colors.blue ,fontWeight: FontWeight.w500),),
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg108)),
            ),
            SizedBox(height: 18,),
