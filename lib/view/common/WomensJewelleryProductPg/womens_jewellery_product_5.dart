...
class WomensJewelleryProduct5 extends StatelessWidget {
  WomensJewelleryProduct5({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Row(
              children:[
                Text("   Visit The  Diva Store",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.blue),),
            ...
            Padding(
              padding: const EdgeInsets.only(top: 8,right:195),
              child: Text("Shining Diva Valentine Gift "),
            ),
            ...
            Image(image: AssetImage(imgbg112),height: 320,width:420,),
            ...
            Row(
              children: [
                ...
                Text("Diva ",style: TextStyle(color:Colors.blue ,fontWeight: FontWeight.w500),),
            ...
            Container(
              ...
              child: Row(
                children:[
                  // SizedBox(width: 30,),
                  Image(image: AssetImage(imgbg112),height:89,),
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg112)),
            ),
            SizedBox(height: 18,),
