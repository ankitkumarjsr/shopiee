...
class Paymentwj5 extends StatelessWidget {
  Paymentwj5({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg112),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(" Shining Diva ",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Diva Retail",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
