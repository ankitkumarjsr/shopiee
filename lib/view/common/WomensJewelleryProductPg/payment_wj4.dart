...
class Paymentwj4 extends StatelessWidget {
  Paymentwj4({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg111),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(" Blessaro NeckLase Pendant ",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Text("Save: \u{20B9} 300.00 (1%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(right: 55),
                                  child: Text("Sold by Blessaro",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
