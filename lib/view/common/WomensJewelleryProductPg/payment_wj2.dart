...
class Paymentwj2 extends StatelessWidget {
  Paymentwj2({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg109),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Fancy Pearl Necklase",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Diva Fashion",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
