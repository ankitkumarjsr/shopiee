...
class Paymentf6 extends StatelessWidget {
  Paymentf6({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg61),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Mens Wear Brown Loafers",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
