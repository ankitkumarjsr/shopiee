...
class Paymentf3 extends StatelessWidget {
  Paymentf3({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg58),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Crocs Mens FootWear",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Crocs Retail",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
