...
import 'package:shopiee/view/common/MensFootWearProductPg/paymentf3.dart';
...
class MensFootwearProduct3 extends StatelessWidget {
  MensFootwearProduct3 ({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Image(image: AssetImage(imgbg58), fit: BoxFit.contain),
                ),
            ...
            Padding(
              ...
              child: Text("Crocs Sports Men's Wear Running Casual Shoes"),
            ),
            Divider(
              thickness: 3,
              color: Colors.grey,
                  ...
                  children: [
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg58),)),
                      ),
                      Padding(
                ...
                Column(
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg58),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
            ...
            Row(
              children: [
                ...
                Text("Crocs Shoes ",style: TextStyle(color:Colors.blue ,fontWeight: FontWeight.w500),),
