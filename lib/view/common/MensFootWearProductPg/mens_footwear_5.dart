...
import 'package:shopiee/view/common/MensFootWearProductPg/paymentf5.dart';
...
class MensFootwearProduct5 extends StatelessWidget {
  MensFootwearProduct5 ({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Image(image: AssetImage(imgbg60), fit: BoxFit.contain),
                ),
            ...
            Row(
              children: [
                SizedBox(width: 13,),
                Text("Visit The Crocs Store",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.cyan),),
                SizedBox(width: 80,),
                RatingBar.builder(
                  itemSize: 20,
                  initialRating: 4.5,
            ...
            Padding(
              ...
              child: Text("Crocs  Men's Wear  Casual Sandels"),
            ),
            Divider(
              thickness: 3,
              color: Colors.grey,
                  ...
                  children: [
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg60),)),
                      ),
                      Padding(
                    ...
                    Row(
                      children: [
                        Text("-56% ",style: TextStyle(color: Colors.red,fontWeight: FontWeight.w500),),
                        SizedBox(width: 10,),
                ...
                Column(
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg60),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
            ...
            Row(
              children: [
                ...
                Text("Sparx Shoes ",style: TextStyle(color:Colors.blue ,fontWeight: FontWeight.w500),),
            ...
            Padding(
              ...
              child: ReadMoreText(
                "Sparx Footwear LEATHER,Batanagar Leather - Bata India Limited , Batanagar Factory ,Batanagar.Kolkata. 700140",
                trimLines: 1,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color: Colors.grey,
                  border: Border.all(color: Colors.black, width: 3)),
              child: Image(image: AssetImage(imgbg130), fit: BoxFit.contain),
            ),
            Divider(
              thickness: 2,
              color: Colors.grey,
            ...
            Row(
              children: [
                ...
                CircleAvatar(
                    maxRadius: 20, backgroundImage: AssetImage(imgbg50)),
                SizedBox(
                  width: 10,
                ),
                Text(
            ...
            Padding(
              padding: const EdgeInsets.only(right: 210),
              child: Text("Size:6 UK  |  Colour:Blue"),
            ),
            SizedBox(
              height: 10,
            ),
