...
import 'package:shopiee/view/common/MensFootWearProductPg/paymentf6.dart';
...
class MensFootwearProduct6 extends StatelessWidget {
  MensFootwearProduct6 ({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Image(image: AssetImage(imgbg61), fit: BoxFit.contain),
                ),
            ...
            Row(
              children: [
                SizedBox(width: 15,),
                Text("Visit The Bata Store",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.cyan),),
                SizedBox(width: 80,),
                RatingBar.builder(
                  itemSize: 20,
                  initialRating: 4.5,
            ...
            Padding(
              ...
              child: Text("Bata  Men's Wear loafers Casual Shoes"),
            ),
            Divider(
              thickness: 3,
              color: Colors.grey,
                  ...
                  children: [
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg61),)),
                      ),
                      Padding(
                ...
                Column(
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg61),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
            ...
            Row(
              children: [
                ...
                Text("BATA Shoes ",style: TextStyle(color:Colors.blue ,fontWeight: FontWeight.w500),),
            ...
            Padding(
              ...
              child: ReadMoreText(
                "BATANAGAR LEATHER,Batanagar Leather - Bata India Limited , Batanagar Factory ,Batanagar.Kolkata. 700140",
                trimLines: 1,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color: Colors.grey,
                  border: Border.all(color: Colors.black, width: 3)),
              child: Image(image: AssetImage(imgbg128), fit: BoxFit.contain),
            ),
            Divider(
              thickness: 2,
              color: Colors.grey,
