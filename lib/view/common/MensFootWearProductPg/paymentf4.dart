...
class Paymentf4 extends StatelessWidget {
  Paymentf4({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg59),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("DSC Sports Running Mens Shoes ",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Row(
                                  children: [
                                    Text("\u{20B9}3799.00",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20),),
                                    SizedBox(width: 8,),
                                    Text("\u{20B9}4500",style: TextStyle(fontSize: 20,decoration: TextDecoration.lineThrough,color: Colors.grey.shade600),),
                                  ],
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Text("Save: \u{20B9} 801.00 (15.5%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(right: 55),
                                  child: Text("Sold By DSC Retail",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
