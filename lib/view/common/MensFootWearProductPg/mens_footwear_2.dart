...
import 'package:shopiee/view/common/MensFootWearProductPg/paymentf2.dart';
...
class MensFootwearProduct2 extends StatelessWidget {
  MensFootwearProduct2 ({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Stack(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Image(image: AssetImage(imgbg63), fit: BoxFit.contain),
                  ),
            ...
            Row(
              children: [
                SizedBox(width: 15,),
                Text("Visit The Asian Store",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.cyan),),
                SizedBox(width: 80,),
                RatingBar.builder(
                  itemSize: 20,
                  initialRating: 4.5,
            ...
            Padding(
              ...
              child: Text("Asian Sports Men's Wear Running Casual Shoes"),
            ),
            Divider(
              thickness: 3,
              color: Colors.grey,
                  ...
                  children: [
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg63),)),
                      ),
                      Padding(
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 10,),
                        Text("\u{20B9}2000.00",style: TextStyle(fontWeight: FontWeight.w500),),
                      ],
                    ),
                    Text(
                      "\u{20B9}2500.00",
                ...
                Column(
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg63),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
            ...
            Row(
              children: [
                ...
                Text("Asian Shoes ",style: TextStyle(color:Colors.blue ,fontWeight: FontWeight.w500),),
            ...
            Padding(
              ...
              child: ReadMoreText(
                "Asian Shoes, - Asian India Private Limited , Tatanagar Factory ,Tatanagar,Jamshedpur. 800140",
                trimLines: 1,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color: Colors.grey,
                  border: Border.all(color: Colors.black, width: 3)),
              child: Image(image: AssetImage(imgbg129), fit: BoxFit.contain),
            ),
            Divider(
              thickness: 2,
              color: Colors.grey,
