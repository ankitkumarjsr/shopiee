...
class Paymentf5 extends StatelessWidget {
  Paymentf5({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg60),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Mens Sandels Sprax",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Sparx Retail",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
