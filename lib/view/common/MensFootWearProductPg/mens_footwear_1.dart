...
import 'package:shopiee/view/common/MensFootWearProductPg/paymentf1.dart';
...
class MensFootwearProduct1 extends StatelessWidget {
  MensFootwearProduct1 ({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
              ...
              child: Stack(
                ...
                children: [
                  ...
                  PageView.builder(
                    ...
                    itemCount: mensformal.length,
                    itemBuilder: (context, index) {
                      return Image.asset(
                        mensformal[index].images,
                        height: 250,
                        width: double.infinity,
                        fit: BoxFit.contain,
                      );
            ...
            Padding(
              ...
              child: Text("BATA Standard Men's Wear Formal Black Shoes"),
            ),
            Divider(
              thickness: 3,
              color: Colors.grey,
                  ...
                  children: [
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg126),)),
                      ),
                      Padding(
                ...
                Column(
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg62),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
