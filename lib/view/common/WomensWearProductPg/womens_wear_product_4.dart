...
class WomenWearProduct4 extends StatelessWidget {
  WomenWearProduct4({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                  "GoSriKi Womens Printed Semi Georgette Saree With Blouse"),
            ),
            SizedBox(
              height: 12,
            ),
                  ...
                  children: [
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg100),)),
                      ),
                      Padding(
                    ...
                    Row(
                      children: [
                        Text("-11% ",style: TextStyle(color: Colors.red,fontWeight: FontWeight.w500),),
                        SizedBox(width: 10,),
                        Text("\u{20B9}4000.00",style: TextStyle(fontWeight: FontWeight.w500),),
                      ],
                    ),
                    Text(
                      "\u{20B9}4500.00",
                ...
                Column(
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg100),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Image(image: AssetImage(imgbg100)),
                  SizedBox(
                    width: 20,
                  ),
                  Text(
