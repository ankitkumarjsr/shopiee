...
class WomenWearProduct1 extends StatelessWidget {
  WomenWearProduct1({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                  "Kanjivaram Kanchipuram Soft Silk Saree Copper Zari Woven Work with Jacquard Blouse Piece For Women(Green)"),
            ),
            SizedBox(
              height: 12,
            ),
            Row(
              children: [
                ...
                SizedBox(width: 8,),
                Text("for ''kanjivaram silk saree''"),
              ],
            ),
            SizedBox(height: 10,),
            SizedBox(height: 10,),
                  ...
                  children: [
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg107),)),
                      ),
                      Padding(
                    ...
                    Row(
                      children: [
                        Text("-10% ",style: TextStyle(color: Colors.red,fontWeight: FontWeight.w500),),
                        SizedBox(width: 10,),
                        Text("\u{20B9}999.00",style: TextStyle(fontWeight: FontWeight.w500),),
                      ],
                    ),
                    Text(
                      "\u{20B9}1099.00",
                ...
                Column(
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg107),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Image(image: AssetImage(imgbg107)),
                  SizedBox(
                    width: 20,
                  ),
                  Text(
            ...
            Padding(
              ...
              child: Text(
                "Kanchipuram Kanjivaram soft silk",
            ...
            Padding(
              padding: const EdgeInsets.only(left: 20),
              child: Text(
                "Most Popular Green Soft Copper Zari Silk Saree For Women Latest Design",style: TextStyle(fontWeight: FontWeight.bold),
              ),
            ),
            SizedBox(height: 10,),
            Padding(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 20),
              child: Text(
                "KANJIVARAM Kanchiputram Latest Design Green Soft Copper Zari Silk Saree For Women",style: TextStyle(fontWeight: FontWeight.bold),
              ),
            ),
            SizedBox(height: 10,),
            Padding(
              padding: const EdgeInsets.only(left: 20),
              child: Text(
                "Kanjivaram Kanchipuram Latest Design Green Soft Copper Zari Silk Saree for Women"
            ...
            Padding(
              ...
              child: Text("I encourage seller to make more  Kanjivaram Saree"),
            ),
            SizedBox(
              height: 10,
            ),
