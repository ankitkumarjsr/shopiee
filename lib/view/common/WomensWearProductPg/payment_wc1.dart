...
class Paymentwc1 extends StatelessWidget {
  Paymentwc1({Key? key}) : super(key: key);
                        ...
                        children:[
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Kanjeevaram Silk Saree",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Kanjeevaram",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
