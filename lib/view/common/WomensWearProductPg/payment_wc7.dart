...
class Paymentwc7 extends StatelessWidget {
  Paymentwc7({Key? key}) : super(key: key);
                        ...
                        children:[
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Sanganeri Women's Kurta",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Sanganeri",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
