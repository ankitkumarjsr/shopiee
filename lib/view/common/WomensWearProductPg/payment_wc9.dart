...
class Paymentwc9 extends StatelessWidget {
  Paymentwc9({Key? key}) : super(key: key);
                        ...
                        children:[
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Womens Royal Kurta",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Royal Export",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
