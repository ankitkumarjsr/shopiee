...
class Paymentwc10 extends StatelessWidget {
  Paymentwc10({Key? key}) : super(key: key);
                        ...
                        children:[
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Womens Vaividhyam Saree",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Row(
                                  children: [
                                    Text("\u{20B9}2500",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20),),
                                    SizedBox(width: 8,),
                                    Text("\u{20B9}2999",style: TextStyle(fontSize: 20,decoration: TextDecoration.lineThrough,color: Colors.grey.shade600),),
                                  ],
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Text("Save: \u{20B9} 499.00 (17%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(right: 55),
                                  child: Text("Sold By VAIVIDHYAM",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
