...
import 'package:shopiee/view/common/WomensWearProductPg/payment_wc10.dart';
...
import 'package:shopiee/view/common/WomensWearProductPg/payment_wc9.dart';
...
class WomenWearProduct10 extends StatelessWidget {
  WomenWearProduct10({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                  "Jaipur Women's Cotton Regular Saree"),
            ),
            SizedBox(
              height: 12,
            ),
                  ...
                  children: [
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg106),)),
                      ),
                      Padding(
                    ...
                    Row(
                      children: [
                        Text("-17% ",style: TextStyle(color: Colors.red,fontWeight: FontWeight.w500),),
                        SizedBox(width: 10,),
                        Text("\u{20B9}2500.00",style: TextStyle(fontWeight: FontWeight.w500),),
                      ],
                    ),
                    Text(
                      "\u{20B9}2999.00",
                ...
                Column(
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg106),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Image(image: AssetImage(imgbg106)),
                  // SizedBox(
                  //   width: 1,
                  // ),
                  Text(
                  ...
                  //   width: 1,
                  // ),
                  Image(image: AssetImage(imgbg105)),
                ],
              ),
            ),
            Container(
