...
class Paymentwc5 extends StatelessWidget {
  Paymentwc5({Key? key}) : super(key: key);
                        ...
                        children:[
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Designer Cotton Saree With Rich",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Ilike Fashion",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
