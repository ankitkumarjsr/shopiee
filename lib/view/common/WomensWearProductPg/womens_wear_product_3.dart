...
class WomenWearProduct3 extends StatelessWidget {
  WomenWearProduct3({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                  "Peegli Saree Women Ethnic Wear Saree Indian Art Silk Traditional Sari"),
            ),
            SizedBox(
              height: 12,
            ),
                  ...
                  children: [
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg99),)),
                      ),
                      Padding(
                    ...
                    Row(
                      children: [
                        Text("-25% ",style: TextStyle(color: Colors.red,fontWeight: FontWeight.w500),),
                        SizedBox(width: 10,),
                        Text("\u{20B9}749.00",style: TextStyle(fontWeight: FontWeight.w500),),
                      ],
                    ),
                    Text(
                      "\u{20B9}999.00",
                ...
                Column(
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg99),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Image(image: AssetImage(imgbg99)),
                  SizedBox(
                    width: 20,
                  ),
                  Text(
