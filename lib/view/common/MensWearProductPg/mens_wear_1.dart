                  ...
                  return GestureDetector(
                    onTap: () =>  showDialog(
                      ...
                      builder: (BuildContext dialogContext) {
                        return AlertDialog(
                          backgroundColor: Colors.grey.shade300,
                          content: Container(child: Image(image: AssetImage(enggPicsList[index].images),)),
                          actions: <Widget>[
                            TextButton(
                              child: Text('Ok'),
                              onPressed: () {
