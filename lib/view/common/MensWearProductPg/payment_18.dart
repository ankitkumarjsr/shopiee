...
class Payment18 extends StatelessWidget {
  Payment18({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg49),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 8,),
                                    Text("\u{20B9}749",style: TextStyle(fontSize: 20,decoration: TextDecoration.lineThrough,color: Colors.grey.shade600),),
                                  ],
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(left: 8),
                                  child: Text("Save: \u{20B9} 50.00 (6.5%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(left: 8),
                                  child: Text("Sold By DEEPSENCE",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
