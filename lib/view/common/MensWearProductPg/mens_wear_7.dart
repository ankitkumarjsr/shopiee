...
import 'package:shopiee/view/common/MensWearProductPg/payment_7.dart';
...
class MensWearProduct7 extends StatelessWidget {
  const MensWearProduct7({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: ReadMoreText(
                "FRONT FULL OPEN HIGH NECK SWEATSHIRTS,U.S.POLO Assn is one of the top brand of widely most used in all over world",
                trimLines: 1,
            ...
            Row(
              children: [
                ...
                Text(
                  "  94% positive rating from 5K+ customers.",
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg64), fit: BoxFit.contain),
            ),
            Divider(
              thickness: 2,
              color: Colors.grey,
            ...
            Padding(
              padding: const EdgeInsets.only(right: 220),
              child: Text("Size:XL  |  Colour:Yellow"),
            ),
            SizedBox(
              height: 5,
            ),
            ...
            Row(
              children: [
                ...
                CircleAvatar(
                    maxRadius: 20, backgroundImage: AssetImage(imgbg41)),
                SizedBox(
                  width: 10,
                ),
                Text(
