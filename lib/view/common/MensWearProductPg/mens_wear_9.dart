...
import 'package:shopiee/view/common/MensWearProductPg/payment_9.dart';
...
class MensWearProduct9 extends StatelessWidget {
  const MensWearProduct9({Key? key}) : super(key: key);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                CircleAvatar(
                    maxRadius: 20, backgroundImage: AssetImage(imgbg68i)),
                SizedBox(
                  width: 10,
                ),
                Text(
