                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg33),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Text("Save: \u{20B9} 249.00 (25%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(right: 55),
                                  child: Text("Sold By Bug Retail",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
