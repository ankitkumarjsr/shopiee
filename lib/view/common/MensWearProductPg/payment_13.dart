...
class Payment13 extends StatelessWidget {
  Payment13({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg46),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    SizedBox(width: 8,),
                                    Text("\u{20B9}899",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20),),
                                    SizedBox(width: 8,),
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 8),
                                  child: Text("Save: \u{20B9} 100.00 (10%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(left: 8),
                                  child: Text("Sold By Daily",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
