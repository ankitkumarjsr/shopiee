...
class Payment14 extends StatelessWidget {
  Payment14({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg47),
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text("A Casual Winter Wear",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Row(
                                  children: [
                                    SizedBox(width: 8,),
                                    Text("\u{20B9}599",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20),),
                                    SizedBox(width: 8,),
                                    Text("\u{20B9}899",style: TextStyle(fontSize: 20,decoration: TextDecoration.lineThrough,color: Colors.grey.shade600),),
                                  ],
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(left: 8),
                                  child: Text("Save: \u{20B9} 300.00 (34%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(left: 8),
                                  child: Text("Sold By Street Knight",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
