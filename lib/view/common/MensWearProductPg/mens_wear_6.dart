...
import 'package:shopiee/view/common/MensWearProductPg/payment_6.dart';
...
class MensWearProduct6 extends StatelessWidget {
  const MensWearProduct6({Key? key}) : super(key: key);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                CircleAvatar(
                    maxRadius: 20, backgroundImage: AssetImage(imgbg81)),
                SizedBox(
                  width: 10,
                ),
                Text(
