...
import 'package:shopiee/view/common/MensWearProductPg/payment_12.dart';
...
class MensWearProduct12 extends StatelessWidget {
  const MensWearProduct12({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.stop, size: 15),
                  Text(
                    "You Can Wear Far and lose weight.",
                    style: TextStyle(fontSize: 14),
                  )
                ],
              ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.stop, size: 15),
                  Text(
                    "Skillful Sweing process with fine intervals",
                    style: TextStyle(fontSize: 14),
                  )
                ],
              ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.stop, size: 15),
                  Text(
                    "The lapel shows the youth of a man",
                    style: TextStyle(fontSize: 14),
                  )
                ],
              ),
            ...
            Padding(
              ...
              child: ReadMoreText(
                " Winter Thick And Warm Solid Color Casual Denim Jacket/Men's Wool Denim Jacket Plus Size all type",
                trimLines: 1,
            ...
            Padding(
              padding: const EdgeInsets.only(right: 110),
              child: Text(
                "Reviewed in India on 14 December 2021",
                style: TextStyle(color: Colors.grey.shade800),
              ),
            ),
            SizedBox(
