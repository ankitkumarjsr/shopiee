...
class Payment9 extends StatelessWidget {
  Payment9({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg39),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Men's Puffer Jacket",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Bewakoof",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
