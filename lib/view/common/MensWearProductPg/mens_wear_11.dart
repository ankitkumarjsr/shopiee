...
import 'package:shopiee/view/common/MensWearProductPg/payment_11.dart';
...
class MensWearProduct11 extends StatelessWidget {
  const MensWearProduct11({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: ReadMoreText(
                "This winter Indian homegrown brand  brings you the best quality 100% cotton "
            ...
            Row(
              children: [
                ...
                CircleAvatar(
                    maxRadius: 20, backgroundImage: AssetImage(imgbg12)),
                SizedBox(
                  width: 10,
                ),
                Text(
