...
class Payment12 extends StatelessWidget {
  Payment12({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg43),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Men'S Denim Trucker Jacket \n& Coats",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold  By OMOONE",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
