...
class Payment5 extends StatelessWidget {
  Payment5({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg37),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Men'S Wrap Coat",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Adidas",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
