...
class Payment1 extends StatelessWidget {
   Payment1({Key? key}) : super(key: key);
                          ...
                          children: [
                            Row(
                              children:[
                                Column(
                                  children: [
                                   Image(image: AssetImage(imgbg32),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text("Casual Engineer Printed Hoodie",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                      ...
                                      SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                      Text("Save: \u{20B9} 1001.00 (51%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                      SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                      Padding(
                                        padding: const EdgeInsets.only(right: 55),
                                        child: Text("Sold By ARDO Retail",style: TextStyle(color: Colors.grey.shade700),),
                                      ),
                                    ],
                                  ),
                                ),
