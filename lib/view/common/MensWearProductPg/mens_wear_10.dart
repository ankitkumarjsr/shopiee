...
import 'package:shopiee/view/common/MensWearProductPg/payment_10.dart';
...
class MensWearProduct10 extends StatelessWidget {
  const MensWearProduct10({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    "Wash Care:Do Not Bleach,wash it with similar colour.",
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.stop, size: 15),
                  Text(
                    "Style Point:Hoodie With Printed gives a trendy casual",
                    style: TextStyle(fontSize: 14),
                  )
                ],
              ),
            ...
            Padding(
              ...
              child: ReadMoreText(
                "This product is quite awesome as because the demin is of the purest quality and widely used all over the world. ",
                trimLines: 1,
