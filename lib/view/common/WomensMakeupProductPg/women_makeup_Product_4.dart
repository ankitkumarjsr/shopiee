...
class WomensMakeupProduct4 extends StatelessWidget {
  WomensMakeupProduct4({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("Lakmé Cushion Matte Lipstick Shell, Long Lasting, Waterproof, Full Coverage, Lightweight Kajal For Oil Free & Dewy Skin, 27ml"),
            ),
            ...
            Image(image: AssetImage(imgbg141)),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("LipStick",style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(height: 3,),
                    Text("\u{20B9}274",style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(height: 3,),
            ...
            Container(
              ...
              child: Row(
                children:[
                  SizedBox(width: 0,),
                  Image(image: AssetImage(imgbg141),height: 505,width: 103,),
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg141)),
            ),
            SizedBox(height: 18,),
