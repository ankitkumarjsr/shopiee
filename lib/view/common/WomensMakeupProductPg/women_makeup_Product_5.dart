...
class WomensMakeupProduct5 extends StatelessWidget {
  WomensMakeupProduct5({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("Makeup Brush Of 10 Pieces, Long Lasting, Waterproof, Full Coverage, Lightweight Kajal For Oil Free & Dewy Skin, 27ml"),
            ),
            ...
            Image(image: AssetImage(imgbg144)),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Brush",style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(height: 3,),
                    Text("\u{20B9}298",style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(height: 3,),
            ...
            Container(
              ...
              child: Row(
                children:[
                  SizedBox(width: 0,),
                  Image(image: AssetImage(imgbg144),height: 505,width: 103,),
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg144)),
            ),
            SizedBox(height: 18,),
