...
class WomensMakeupProduct3 extends StatelessWidget {
  WomensMakeupProduct3({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("Lakmé Insta Eyeliner, Shell, Long Lasting, Waterproof, Full Coverage, Lightweight Kajal For Oil Free & Dewy Skin, 27ml"),
            ),
            ...
            Image(image: AssetImage(imgbg145)),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Eyeliner",style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(height: 3,),
                    Text("\u{20B9}141",style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(height: 3,),
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg145)),
            ),
            SizedBox(height: 18,),
