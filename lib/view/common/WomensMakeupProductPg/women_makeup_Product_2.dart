...
class WomensMakeupProduct2 extends StatelessWidget {
  WomensMakeupProduct2({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("Lakmé Eyeconic Kajal, Shell, Long Lasting, Waterproof, Full Coverage, Lightweight Kajal For Oil Free & Dewy Skin, 27ml"),
            ),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Kajal",style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(height: 3,),
                    Text("\u{20B9}200",style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(height: 3,),
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg143)),
            ),
            SizedBox(height: 18,),
