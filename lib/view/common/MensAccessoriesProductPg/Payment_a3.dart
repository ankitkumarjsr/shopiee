...
import 'package:shopiee/view/common/MensAccessoriesProductPg/mens_accessories3.dart';
import 'package:shopiee/view/common/MensWearProductPg/mens_wear_1.dart';
import 'package:numeric_keyboard/numeric_keyboard.dart';


class Paymenta3 extends StatelessWidget {
  Paymenta3({Key? key}) : super(key: key);
          ...
          appBar:AppBar(
              ...
              actions: [
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => MensAccessoriesProduct3(),));
                    },
                        ...
                        children:[
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Winter Wear Cap ",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Row(
                                  children: [
                                    Text("\u{20B9}299",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20),),
                                    SizedBox(width: 8,),
                                    Text("\u{20B9}1599",style: TextStyle(fontSize: 20,decoration: TextDecoration.lineThrough,color: Colors.grey.shade600),),
                                  ],
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Text("Save: \u{20B9} 1300.00 (81%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(right: 55),
                                  child: Text("Sold By Boldfit",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
