...
class Paymenta8 extends StatelessWidget {
  Paymenta8({Key? key}) : super(key: key);
          ...
          appBar:AppBar(
              ...
              actions: [
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => MensAccessoriesProduct8(),));
                    },
                        ...
                        children:[
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Mens Casual Caps",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
