...
class Paymenta5 extends StatelessWidget {
  Paymenta5({Key? key}) : super(key: key);
          ...
          appBar:AppBar(
              ...
              actions: [
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => MensAccessoriesProduct5(),));
                    },
                        ...
                        children:[
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Mens Golden OM Namah Siway\n Kara ",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Sold By Discount4product",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
