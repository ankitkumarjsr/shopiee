...
import 'mens_accessories4.dart';


class Paymenta4 extends StatelessWidget {
  Paymenta4({Key? key}) : super(key: key);
          ...
          appBar:AppBar(
              ...
              actions: [
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => MensAccessoriesProduct4(),));
                    },
