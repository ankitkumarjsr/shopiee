...
class Paymenta1 extends StatelessWidget {
  Paymenta1({Key? key}) : super(key: key);
          ...
          appBar:AppBar(
              ...
              actions: [
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => MensAccessoriesProduct1(),));
                    },
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg69i),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Casual Black Printed Bug Hoodie",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
