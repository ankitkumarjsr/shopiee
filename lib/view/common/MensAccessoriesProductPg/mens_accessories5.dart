...
class MensAccessoriesProduct5 extends StatelessWidget {
  MensAccessoriesProduct5({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Row(
              children:[
                Text("   Visit The Discount4Product Store",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.blue),),
            ...
            Padding(
              ...
              child: Text("Discount4product OM Namah Siway Golden Color brecelet Kada For Mens & Womens"),
            ),
            ...
            Image(image: AssetImage(imgbg83),height: 320,width:420,),
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg83)),
            ),
            SizedBox(height: 18,),
            ...
            Padding(
              ...
              child: Text(
                  "I encourage seller to make more GOLDEN Hoodie."),
            ),
            SizedBox(
              height: 10,
            ),
