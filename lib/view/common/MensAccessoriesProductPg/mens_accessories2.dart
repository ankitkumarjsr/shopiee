...
class MensAccessoriesProduct2 extends StatelessWidget {
  MensAccessoriesProduct2({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg70)),
            ),
            SizedBox(height: 18,),
            Container(
              height: MediaQuery.of(context).size.height*0.40,
