...
import 'package:shopiee/view/common/MensAccessoriesProductPg/mens_accessories10.dart';
import 'package:shopiee/view/common/MensAccessoriesProductPg/mens_accessories2.dart';
import 'package:shopiee/view/common/MensAccessoriesProductPg/mens_accessories5.dart';
import 'package:shopiee/view/common/MensAccessoriesProductPg/mens_accessories6.dart';
import 'package:shopiee/view/common/MensAccessoriesProductPg/mens_accessories7.dart';
import 'package:shopiee/view/common/MensWearProductPg/mens_wear_1.dart';
import 'package:numeric_keyboard/numeric_keyboard.dart';

import 'mens_accessories11.dart';
import 'mens_accessories12.dart';
import 'mens_accessories8.dart';
import 'mens_accessories9.dart';


class Paymenta12 extends StatelessWidget {
  Paymenta12({Key? key}) : super(key: key);
          ...
          appBar:AppBar(
              ...
              actions: [
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => MensAccessoriesProduct12(),));
                    },
                    ...
                    children: [
                      Row(
                        children:[
                          Column(
                            children: [
                              Image(image: AssetImage(imgbg86),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Fastrack Gogglles For Men's",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Row(
                                  children: [
                                    Text("\u{20B9}1549",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20),),
                                    SizedBox(width: 8,),
                                    Text("\u{20B9}499",style: TextStyle(fontSize: 20,decoration: TextDecoration.lineThrough,color: Colors.grey.shade600),),
                                  ],
                                ),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Text("Save: \u{20B9} 450.00 (23%)",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.red),),
                                SizedBox(height: MediaQuery.of(context).size.height*0.014,),
                                Padding(
                                  padding: const EdgeInsets.only(right: 40),
                                  child: Text("Sold By FASTRACK India",style: TextStyle(color: Colors.grey.shade700),),
                                ),
                              ],
                            ),
                          ),
