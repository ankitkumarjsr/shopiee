...
class MensAccessoriesProduct10 extends StatelessWidget {
  MensAccessoriesProduct10({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Image(image: AssetImage(imgbg87),height: 320,width:420,),
                  ...
                  children: [
                    ...
                    Stack(children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.black,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg87),)),
                      ),
                      Padding(
                ...
                Column(
                  children: [
                    Stack(children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: CircleAvatar(backgroundColor: Colors.white,radius: 34,child: CircleAvatar(radius: 31,backgroundImage: AssetImage(imgbg87),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 60),
                        child: Container(
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg87)),
            ),
            SizedBox(height: 18,),
