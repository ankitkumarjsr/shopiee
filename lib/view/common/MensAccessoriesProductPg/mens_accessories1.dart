...
class MensAccessoriesProduct1 extends StatelessWidget {
   MensAccessoriesProduct1({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Row(
              children: [
                Image(image: AssetImage(imgbg69i),height: 150,width: 180,),
                Column(
            ...
            Container(
              ...
              child: Image(image: AssetImage(imgbg69i)),
            ),
            SizedBox(height: 18,),
            Container(
              height: MediaQuery.of(context).size.height*0.40,
